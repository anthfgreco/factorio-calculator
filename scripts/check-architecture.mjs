...
const allowedImports = new Map([
  ...
  ["planning.ts", new Set(["math.ts", "models.ts", "planning/contracts.ts", "quality/math.ts", "recipes.ts"])],
  ...
  [
    "quality/vulcanus.ts",
    new Set(["factory.ts", "math.ts", "quality/contracts.ts", "quality/practical.ts", "recipes.ts"]),
  ],
  ...
  ["state.ts", new Set(["application/contracts.ts", "factory.ts", "math.ts", "models.ts", "quality/contracts.ts"])],
  ...
  ["url/codec.ts", new Set(["quality/contracts.ts"])],

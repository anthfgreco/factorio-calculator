...
!(function (t, n) {
  ...
  function q(t, n, e) {
    ...
    if (a > 0)
      ...
      for (a = -a, t = Math.ceil(t * a), n = Math.floor(n * a), o = new Array((i = Math.ceil(n - t + 1))); ++u < i;)
        o[u] = (t + u) / a
  ...
  function ht(t, n) {
    ...
    function l(l) {
      var h = null == r ? (n.ticks ? n.ticks.apply(n, e) : n.domain()) : r,
        d = null == i ? (n.tickFormat ? n.tickFormat.apply(n, e) : ot) : i,
        p = Math.max(o, 0) + u,
        g = n.range(),
        y = +g[0] + 0.5,
        v = +g[g.length - 1] + 0.5,
        _ = (n.bandwidth ? st : ft)(n.copy()),
  ...
  function Bt(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < h; ++u)
      ((f = a.call(t, o[u], u, o) + ""),
        (c = s.get(f)) ? ((r[u] = c), (c.__data__ = o[u]), s.delete(f)) : (e[u] = new Ot(t, o[u])))
  ...
  Pn.prototype = zn.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? Ht : jt) : "function" == typeof n ? (e.local ? $t : Vt) : e.local ? Gt : Xt)(e, n),
      )
    },
    style: function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? Zt : "function" == typeof n ? Qt : Kt)(t, n, null == e ? "" : e))
        : Jt(this.node(), t)
    },
      ...
      (n = re.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ? pe(n)
            : 3 === e
              ? new _e(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1)
              : 8 === e
  ...
  ;(Wn(
    ...
    Zn(Kn, {
      ...
      rgb: function () {
        ...
        return new _e(
          Ie(3.1338561 * (n = Ne * Ue(n)) - 1.6168667 * (t = 1 * Ue(t)) - 0.4906146 * (e = Ce * Ue(e))),
  ...
  function kr(t, n, e, r, i, o) {
    ...
    return (
      ...
      { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Sr, skewX: Math.atan(c) * Sr, scaleX: a, scaleY: u }
    )
  }
  function Nr(t, n, e, r) {
    function i(t) {
  ...
  function ui(t) {
    Gr ||
      ...
      t - Zr > 24
        ? (t < 1 / 0 && (Vr = setTimeout(oi, t - Qr.now() - Kr)), $r && ($r = clearInterval($r)))
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
        for (var u, c, f = r[a], s = f.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
          (u = f[h]) &&
            ...
            ("__data__" in u && (c.__data__ = u.__data__), (l[h] = c), li(l[h], n, e, h, l, pi(u, e)))
              ...
              (function (t, n, e) {
                ...
                return function () {
                  var a = Jt(this, t),
                    ...
                    c = u + ""
                  return (
                    null == u && (this.style.removeProperty(t), (c = u = Jt(this, t))),
    ...
    function h(e) {
      ...
      function I(t) {
        ...
        switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
          ...
          case To:
            D[1]
              ? (x && ((a = ko(S, No(k, D[0][0]))), (h = ko(S, No(k, D[1][0]))), (x = 1)),
                w && ((c = ko(E, No(N, D[0][1]))), (p = ko(E, No(N, D[1][1]))), (w = 1)))
              : (x < 0
      ...
      function Y(t) {
        switch (t.keyCode) {
          ...
          case 18:
            m === To &&
              (x && ((l = h - C * x), (i = a + C * x)), w && ((d = p - P * w), (u = c + P * w)), (m = So), I())
            break
          case 32:
            ;(m !== To && m !== So) ||
              (x < 0 ? (l = h - C) : x > 0 && (i = a - C),
      ...
      function L(t) {
        switch (t.keyCode) {
          ...
          case 32:
            m === Ao &&
              (t.altKey
                ? (x && ((l = h - C * x), (i = a + C * x)), w && ((d = p - P * w), (u = c + P * w)), (m = So))
                : (x < 0 ? (l = h) : x > 0 && (i = a), w < 0 ? (d = p) : w > 0 && (u = c), (m = To)),
              R.attr("cursor", Ro[b]),
              I())
            break
          default:
      ...
      (l.prototype = {
        ...
        emit: function (n, e, r) {
          ...
          a.call(
            n,
            this.that,
            new mo(n, { sourceEvent: e, target: c, selection: t.output(this.state.selection), mode: r, dispatch: a }),
            i,
          )
        },
      }),
  ...
  ca.prototype = fa.prototype = {
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      ;(null === this._x1
        ? (this._ += "M" + c + "," + f)
        : (Math.abs(this._x1 - c) > aa || Math.abs(this._y1 - f) > aa) && (this._ += "L" + c + "," + f),
        e &&
          (l < 0 && (l = (l % oa) + oa),
          l > ua
            ? (this._ +=
  ...
  function ba(t) {
    ...
    function f() {
      ...
      if (
        (c || (c = f = fa()),
        h > ta &&
          (Vo(y - g) > 2 * h + ta ? (y > g ? ((g += h), (y -= h)) : ((g -= h), (y += h))) : (g = y = (g + y) / 2),
          Vo(b - _) > 2 * h + ta ? (b > _ ? ((_ += h), (b -= h)) : ((_ -= h), (b += h))) : (_ = b = (_ + b) / 2)),
  ...
  class Fa {
    ...
    update() {
      ...
      for (let o, a, u = 0; u < this._ids.length; u++) {
        ...
        let _ = e[y]
        for (; (g = e[_]), Ia(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]);)
          ((v = this._addTriangle(_, c, g, r[c], -1, r[_])), (r[c] = this._legalize(v + 2)), (e[_] = _), A--, (_ = g))
        if (y === l)
          for (; (g = n[y]), Ia(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]);)
  ...
  function La(t, n, e, r) {
    if (r - e <= 20)
      ...
      ;((t[e + 1] = t[o]),
        (t[o] = a),
        r - i + 1 >= o - e ? (La(t, n, i, r), La(t, n, e, o - 1)) : (La(t, n, e, o - 1), La(t, n, i, r)))
    }
  }
  function ja(t, n, e) {
    const r = t[n]
  ...
  class Va {
    ...
    arc(t, n, e) {
      ...
      ;(null === this._x1
        ? (this._ += `M${r},${i}`)
        : (Math.abs(this._x1 - r) > Ga || Math.abs(this._y1 - i) > Ga) && (this._ += "L" + r + "," + i),
  ...
  class Wa {
    ...
    *neighbors(t) {
    ...
    _clipFinite(t, n) {
      ...
      for (let h = 0; h < e; h += 2)
        if (((r = f), (i = s), (f = n[h]), (s = n[h + 1]), (o = l), (l = this._regioncode(f, s)), 0 === o && 0 === l))
  ...
  ;((Xu.copy = function () {
    ...
    for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop());)
      for (var i = 0; i < 4; ++i)
        (n = r.source[i]) &&
          (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Hu(n)))
    return e
  }),
    (Xu.add = function (t) {
  ...
  function pc(t) {
    ...
    function l(t) {
      var n = (t = ac(t)).fill,
        ...
        v = t.trim,
        _ = t.type
      ;("n" === _ ? ((g = !0), (_ = "g")) : fc[_] || (void 0 === y && (y = 12), (v = !0), (_ = "g")),
        (d || ("0" === n && "=" === e)) && ((d = !0), (n = "0"), (e = "=")))
    ...
    jf = {
      ...
      polygonEnd: function () {
        ;(gf.polygonEnd(),
          ...
          (jf.lineStart = Gf),
          (jf.lineEnd = Vf),
          df < 0 ? ((nf = -(rf = 180)), (ef = -(of = 90))) : sf > bc ? (of = 90) : sf < -1e-6 && (ef = -90),
          (hf[0] = nf),
          (hf[1] = rf))
      },
      sphere: function () {
  ...
  function os(t, n) {
    ...
    var e = Cc((n *= Sc)),
      ...
      o = Fc(n),
      a = Nc(
        Uc((a = Yf * o - Lf * i) * a + (a = Lf * r - Bf * o) * a + (a = Bf * i - Yf * r) * a),
        Bf * r + Yf * i + Lf * o,
      )
  ...
  function Es(t, n) {
    ...
    for (var f = 0, s = t.length; f < s; ++f)
      if ((h = (l = t[f]).length))
        for (
          var l, h, d = l[h - 1], p = Ss(d), y = d[1] / 2 + Mc, v = Fc(y), _ = Cc(y), b = 0;
          b < h;
          ++b, p = x, v = M, _ = A, d = m
        ) {
          var m = l[b],
            ...
            : i !== u &&
              ...
              (r = (function (t, n, e, r) {
                var i,
                  ...
                  a = Fc(t - e)
                return Ec(a) > bc
                  ? kc((Fc(n) * (o = Cc(r)) * Fc(e) - Fc(r) * (i = Cc(n)) * Fc(t)) / (i * o * a))
                  : (n + r) / 2
              })(e, r, o, a)),
              t.point(i, r),
              t.lineEnd(),
  ...
  function il() {
    ...
    return (
      ...
      (v.precision = function (h) {
        return arguments.length
          ? ((y = +h), (c = el(o, i, 90)), (f = rl(n, t, y)), (s = el(u, a, 90)), (l = rl(r, e, y)), v)
          : y
      }),
      v
        .extentMajor([
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
            ...
            if (b > 4 * n && g--) {
              var m = a + h,
                ...
                C = k - i,
                P = _ * N - v * C
              ;((P * P) / b > n || Ec((v * N + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < sh) &&
  ...
  function gh(t) {
    ...
    return (
      ...
      (E.clipExtent = function (t) {
        return arguments.length
          ? ((T =
              null == t
                ? ((A = r = i = o = null), fl)
                : Is((A = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))),
            C())
          : null == A
            ? null
            : [
      ...
      (E.rotate = function (t) {
        return arguments.length
          ? ((y = (t[0] % 360) * Sc), (v = (t[1] % 360) * Sc), (_ = t.length > 2 ? (t[2] % 360) * Sc : 0), N())
          : [y * Tc, v * Tc, _ * Tc]
      }),
      (E.angle = function (t) {
  ...
  ;((Rh.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e = (r * (Ch + Ph * i + o * (zh + Dh * i)) - n) / (Ch + 3 * Ph * i + o * (7 * zh + 9 * Dh * i))) * r) *
        i *
        i),
      !(Ec(e) < mc));
      ++a
    ...
    function w(t, n) {
      return function (e) {
        ...
        for (e instanceof Date || (e = new Date(+e)); ++u < f;)
          37 === t.charCodeAt(u) &&
            (a.push(t.slice(c, u)),
            null != (i = Kg[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = "e" === r ? " " : "0"),
            (o = n[r]) && (r = o(e, i)),
            a.push(r),
            (c = u + 1))
      ...
      return function (e) {
        ...
        if (
          ...
          ("W" in o || "U" in o) &&
            ...
            (i = "Z" in o ? Vg($g(o.y, 0, 1)).getUTCDay() : Gg($g(o.y, 0, 1)).getDay()),
            (o.m = 0),
  ...
  function Sv(t, n, r, i, o, a, u, c, f) {
    ...
    function w(e) {
      return (
        u(e) < e ? d : a(e) < e ? p : o(e) < e ? g : i(e) < e ? y : n(e) < e ? (r(e) < e ? v : _) : t(e) < e ? b : m
      )(e)
    }
    function M(n, r, i) {
  ...
  function Cv() {
    ...
    function p(t) {
      return function (n) {
        var e, r, i
        return arguments.length ? (([e, r, i] = n), (l = jr(t, [e, r, i])), d) : [l(0), l(0.5), l(1)]
      }
    }
    return (
      (d.domain = function (a) {
  ...
  function Dm(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (e - t._y1) / (i || (r < 0 && -0)),
      u = (o * i + a * r) / (r + i)
    return (zm(o) + zm(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0
  }
  function qm(t, n) {
    var e = t._x1 - t._x0
      ...
      lineEnd: function () {
        ...
        if (e)
          if ((this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e))
            ...
            for (var r = Bm(t), i = Bm(n), o = 0, a = 1; a < e; ++o, ++a)
  ...
  ;((tx.prototype = Qm.prototype),
        ...
        if ((u || (u = c = fa()), l < s && ((f = l), (l = s), (s = f)), l > sb))
          if (p > db - sb)
            (u.moveTo(l * ob(h), l * cb(h)),
              u.arc(0, 0, l, h, d, !g),
              s > sb && (u.moveTo(s * ob(d), s * cb(d)), u.arc(0, 0, s, d, h, g)))
          else {
            var y,
              v,
              _ = h,
            ...
            if (T > sb) {
              var N = gb((T / s) * cb(A)),
                C = gb((T / l) * cb(A))
              ;((w -= 2 * N) > sb ? ((m += N *= g ? 1 : -1), (x -= N)) : ((w = 0), (m = x = (h + d) / 2)),
                (M -= 2 * C) > sb ? ((_ += C *= g ? 1 : -1), (b -= C)) : ((M = 0), (_ = b = (h + d) / 2)))
            }
            var P = l * ob(_),
              z = l * cb(_),
              D = s * ob(x),
            ...
            ;(M > sb
              ? k > sb
                ? ((y = wb(U, I, P, z, l, k, g)),
                  ...
                  k < S
                    ? u.arc(y.cx, y.cy, k, ib(y.y01, y.x01), ib(v.y01, v.x01), !g)
                    : (u.arc(y.cx, y.cy, k, ib(y.y01, y.x01), ib(y.y11, y.x11), !g),
                      u.arc(0, 0, l, ib(y.cy + y.y11, y.cx + y.x11), ib(v.cy + v.y11, v.cx + v.x11), !g),
                      u.arc(v.cx, v.cy, k, ib(v.y11, v.x11), ib(v.y01, v.x01), !g)))
              ...
              s > sb && w > sb
                ? E > sb
                  ? ((y = wb(D, q, F, O, s, -E, g)),
                    ...
                    E < S
                      ? u.arc(y.cx, y.cy, E, ib(y.y01, y.x01), ib(v.y01, v.x01), !g)
                      : (u.arc(y.cx, y.cy, E, ib(y.y01, y.x01), ib(y.y11, y.x11), !g),
                        u.arc(0, 0, s, ib(y.cy + y.y11, y.cx + y.x11), ib(v.cy + v.y11, v.cx + v.x11), g),
                        u.arc(v.cx, v.cy, E, ib(v.y11, v.x11), ib(v.y01, v.x01), !g)))
                  : u.arc(0, 0, s, x, m, g)
                : u.lineTo(D, q))
          }
        else u.moveTo(0, 0)
    ...
    (t.contourDensity = function () {
      ...
      return (
        ...
        (l.thresholds = function (t) {
          return arguments.length
            ? ((s = "function" == typeof t ? t : Array.isArray(t) ? wa(ma.call(t)) : wa(t)), l)
            : s
        }),
    ...
    (t.curveBundle = ym),
    (t.curveCardinal = bm),
    (t.curveCardinalClosed = xm),
    (t.curveCardinalOpen = Mm),
    (t.curveCatmullRom = Sm),
    (t.curveCatmullRomClosed = km),
    (t.curveCatmullRomOpen = Cm),
    (t.curveLinear = Sb),
    ...
    (t.forceManyBody = function () {
      ...
      function h(t, o, f, s) {
        ...
        if (!(t.length || p >= u)) {
          ;(t.data !== n || t.next) &&
            (0 === l && (p += (l = Vu(e)) * l), 0 === h && (p += (h = Vu(e)) * h), p < a && (p = Math.sqrt(a * p)))
          do {
      ...
      if (((of = rf = -(nf = ef = 1 / 0)), (lf = []), Wc(t, jf), (e = lf.length))) {
        for (lf.sort(Qf), n = 1, o = [(r = lf[0])]; n < e; ++n)
          Jf(r, (i = lf[n])[0]) || Jf(r, i[1])
            ? (Kf(r[0], i[1]) > Kf(r[0], r[1]) && (r[1] = i[1]), Kf(i[0], r[1]) > Kf(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i))
    ...
    (t.geoCentroid = function (t) {
      ...
      var n = +Rf,
        ...
        r = +Of,
        i = Dc(n, e, r)
      return i < mc && ((n = zf), (e = Df), (r = qf), kf < bc && ((n = Nf), (e = Cf), (r = Pf)), (i = Dc(n, e, r)) < mc)
        ? [NaN, NaN]
        : [Nc(e, n) * Tc, Yc(r / i) * Tc]
    }),
        ...
        (b.clipExtent = function (t) {
          return arguments.length
            ? ((v =
                null == t
                  ? ((d = e = r = i = null), fl)
                  : Is((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))),
              _())
            : null == d
              ? null
              : [
    ...
    (t.interpolateRainbow = function (t) {
      ...
      return ((V_.h = 360 * t - 100), (V_.s = 1.5 - 1.5 * n), (V_.l = 0.8 - 0.9 * n), V_ + "")
    }),
    ...
    (t.pointers = function (t, n) {
      return (
        t.target && ((t = On(t)), void 0 === n && (n = t.currentTarget), (t = t.touches || [t])),
    ...
    (t.scaleTime = function () {
      return rp.apply(
        Sv(bg, vg, rg, tg, Qp, Zp, $p, Yp, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
        arguments,
      )
    }),
    (t.scaleUtc = function () {
      return rp.apply(
        Sv(Hg, Lg, kg, Tg, Mg, xg, $p, Yp, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
        arguments,
      )
    }),
    (t.scan = function (t, n) {
    ...
    (t.stack = function () {
      ...
      function i(i) {
        var o,
          a,
          u = Array.from(t.apply(this, arguments), Xm),
          c = u.length,
          f = -1
    ...
    (t.stackOrderAppearance = Gm),
    (t.stackOrderAscending = $m),
    ...
    (t.stratify = function () {
      ...
      function e(e) {
        ...
        for (i = 0; i < l; ++i)
          ((r = s[i]),
            (u = s[i] = new Zh(r)),
            null != (c = t(r, i, e)) && (c += "") && ((f = u.id = c), h.set(f, h.has(f) ? xd : u)),
    ...
    (t.symbol = function (t, n) {
      ...
      function r() {
        var r
        if ((e || (e = r = fa()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r))
        ...
        n.parent.A = (function (n, e, r) {
          if (e) {
            for (
              ...
              ((c = Td(c)),
                ((a = Sd(a)).a = n),
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Ed(kd(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m))
    ...
    (t.zoom = function () {
      ...
      function S(e, ...i) {
        if (r.apply(this, arguments)) {
          ...
          for (nx(e), a = 0; a < s; ++a)
            ((c = [(c = Un((u = f[a]), this)), this.__zoom.invert(c), u.identifier]),
              l.touch0
